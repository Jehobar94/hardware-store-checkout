...
const copy = {
  en: {
    ...
    checkout: 'Checkout', cardNumber: 'Card number', cardholder: 'Cardholder name', expiry: 'MM/YY', cvc: 'CVC', pay: 'Pay securely', terms: 'I accept the payment terms', emptyCart: 'Your cart is empty', add: 'Add to cart', quantity: 'Quantity', back: 'Back to products', paymentMethod: 'Payment method', visa: 'Visa', mastercard: 'Mastercard', invalidCard: 'Enter a valid card number',
  },
  es: {
    language: 'English',
    cart: 'Carrito',
